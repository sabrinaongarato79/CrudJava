...
public class AppServlet extends HttpServlet {
    ...
    private static final String URI_PREVIEW = "WEB-INF/pages/alumnos/previewAlumno.jsp";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (laAccion) {
            ...
            case "view":
                ...
                req.setAttribute("alumnoPreview", alum);
                req.getRequestDispatcher(URI_PREVIEW).forward(req, resp);
                break;
            default:
